...
class FolderSelect extends Component {
  ...
  render() {
    ...
    return (
      <div
        className="details__folder-select folder-select"
        onClick={this.onFolderSelectClick}
      >
        ...
        {isOpen && (
          <div
            ...
            className="folder-select__dropdown"
          >
            <div
              key={0}
            ...
            {folders.map(({ id, name }) => {
              ...
              return (
                <div
                  key={id}
                  className={className}
                  onClick={() => this.onFolderItemClick(id)}
                >
                  <Icon
                    className="folder-select__item-icon"
                    path={folderIcon}
                  />
